...
INSTALLED_APPS = [
    ...
    'bankrecon',
    'triplec',
    'batchprinting_accountspayable',
    'batchprinting_checkvoucher',
    'batchprinting_journalvoucher',
    'triplecbureau',
    'triplecsubtype',
    'triplecsection',
    'triplecpublication',
    'triplecpage',
    'triplecclassification',
    'triplecsupplier',
    'triplecrate',
    'triplecvariousaccount',
